...
public class ActivityEventAspect {
    ...
    public void publishActivityEvents(JoinPoint joinPoint, PublishActivityEvents publishActivityEvents, Object result) {
    ...
    private void handleReactiveMethod(Mono<?> resultMono, ActivityEventType eventType, JoinPoint joinPoint) {
        resultMono
                .doOnSuccess(entity -> {
                    if (entity != null) {
